...
const Schedule = () => {
    return (
      <div className="container md:mx-auto bg-gray ">
        <h1 className="mt-4 mb-6 text-2x">Schedule</h1>
        ...
        <p>There’s an open bar at the venue for your preferred alcoholic beverages.
        It’s a no cash facility, only card swipes.
        </p>
        <p>The whole programme will be at Rosemary Hill, The Greenhouse Café. Click link to get directions.</p>
        <button>Get Directions</button>
        <p className="more-info">
        For more information, kindly contact Wedding Coordinator 
        </p>
        <p className="contact-info">
        Bell Mpebe:072 581 2840
        </p>
      </div>
    )
}
